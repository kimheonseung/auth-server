...
public class SignUpServiceTests {
    ...
    class Success {
        ...
        public void signUpByMemberSignUpRequestVO() throws Exception {
            ...
            given(redisMemberRepository.save(any(RedisMember.class))).willReturn(RedisMember.builder()
                    ...
                    .authKey("authKey")
                    .build());
            doNothing().when(mailHelper).sendSignupValidationMail(any(String.class), any(String.class));
            given(aes256Helper.decrypt(givenPassword)).willReturn("test");
            // when
            SignUpResponseDTO signUpResponseDTO = signUpService.signUpByMemberSignUpRequestVO(signUpRequestDTO);
            // then
        ...
        public void commitSignUpByEmailAndAuthKey() {
            ...
            // when
            SignUpResponseDTO signUpResponseDTO = signUpService.commitSignUpByEmailAndAuthKey(givenEmail, givenAuthKey);
            // then
    ...
    class Fail {
        ...
        public void signUpByMemberSignUpRequestVO_duplicate_email() {
            ...
            // then
            assertThrows(DuplicateEmailException.class, () -> signUpService.signUpByMemberSignUpRequestVO(signUpRequestDTO));
        }
        ...
        public void signUpByMemberSignUpRequestVO_password() throws Exception {
            ...
            // then
            assertThrows(PasswordException.class, () -> signUpService.signUpByMemberSignUpRequestVO(signUpRequestDTO));
        }
        ...
        public void commitSignUpByEmailAndAuthKey_redis_error() {
            ...
            // then
            assertThrows(SignUpException.class, () -> signUpService.commitSignUpByEmailAndAuthKey(givenEmail, givenAuthKey));
        }
